 ...
 */
public abstract interface IExtVisitorCmd<R, I, P, H extends IExtVisitorHost<I, ? super H>>{
	/**
	 * The method that is run by AExtVisitor when the case associated with this
	 * command is executed.
	 * 
	 * @param <T>
	 *            The type of the host the is expected to call this method. T is
	 *            restricted to be a subclass of IExtVisitorHost&lt;I, ? super
	 *            H&gt;
	 * @param index
	 *            The index value for the case for which this command is
	 *            associated.
	 * @param host
	 *            The host for the visitor
	 * @param params
	 *            Vararg input parameters
	 * @return The value returned by the running this command.
	 */
	public abstract <T extends IExtVisitorHost<I, ? super H>> R apply(I index,
			T host, @SuppressWarnings("unchecked") P... params);
}