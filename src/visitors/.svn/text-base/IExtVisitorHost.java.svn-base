 ...
 */
/**
 * Top-level extended visitor interfaces.  Completely implementation-independent. */public abstract interface IExtVisitorHost<I, H extends IExtVisitorHost<I,? extends H>>{
  /**
